<template>
  <div class="dashboard-container">
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第1期“云尚大讲堂”互动讨论获奖名单公布</p>
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">张飞</span> 发布了 第2期“云尚大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">柳继</span> 发布了 第3期“云尚大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
    ...
    <el-dialog :visible="showDialog" title="离职申请" @close="btnCancel">
      <el-form ref="ruleForm" status-icon label-width="120px" :model="ruleForm" :rules="rules">
        <el-form-item label="期望离职时间" prop="exceptTime">
          <el-date-picker v-model="ruleForm.exceptTime" value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="选择日期时间" />
        </el-form-item>
...
import Radar from '../dashboard/components/radar.vue'
